...
process insertDataToQCloud {
        ...
        HLV_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '653.3' $basename_sh)
        ...
        VPQ_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '756.4' $basename_sh)
        ...
        EAC_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '554.2' $basename_sh)
        ...
        EYE_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '751.8' $basename_sh) 
        ...
        ECC_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '583.8' $basename_sh) 
        ...
        SLH_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '710.3' $basename_sh) 
        ...
        TCC_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '488.5' $basename_sh) 
        ...
        NEC_area=$(source !{binfolder}/parsing_qcloud.sh; get_qc_area_from_json '517.7' $basename_sh) 
